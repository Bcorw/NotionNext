...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Liyk', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '认真学习的I人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://wreh.top', // 网站地址
